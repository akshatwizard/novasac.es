...
export default function SearchBar() {
    ...
    return (
        <div className="hidden max-w-xl w-full md:flex items-center h-10">
            ...
            <button className="shrink-0 bg-primary-100 flex items-center justify-center w-12 h-full transition-colors duration-300 ease-in-out hover:bg-primary-200 cursor-pointer rounded-tr-sm rounded-br-sm">
