                    ...
                    {industries.map((item, index) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group p-6 rounded-xl border border-zinc-200 hover:border-primary-300 hover:shadow-lg transition-all duration-300 bg-white block"
                            >
                                ...
                                <span className="inline-block mt-4 text-xs font-semibold text-primary-500 group-hover:gap-2 transition-all">
                                    Learn more →
                                </span>
                            </Link>
                        );
