...
export default function Recycling() {
    return (
        <>
                ...
                <Wrapper className="relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="inline-flex w-fit items-center gap-2 rounded-full bg-forest-700/15 border border-forest-light/30 px-4 py-1.5 backdrop-blur-sm">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                <Link
                                    href="/contact"
                                    className="inline-flex items-center gap-2 bg-forest-800 hover:bg-forest-700 transition-colors text-white font-semibold px-6 py-3 rounded-full text-sm"
                                >
                                    Contact Us
                                ...
                                <Link
                                    href="#how"
                                    className="inline-flex items-center gap-2 border border-white/20 hover:border-forest-light hover:text-forest-light transition-colors text-slate-300 font-medium px-6 py-3 rounded-full text-sm backdrop-blur-sm"
                                >
                                    How It Works
                                </Link>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {heroStats.map((item) => {
                                ...
                                return (
                                    <div
                                        key={item.label}
                                        className="rounded-2xl bg-white/5 border border-forest-light/20 backdrop-blur-md p-6 flex flex-col gap-3 hover:bg-forest-700/10 hover:border-forest-light/40 transition-all "
                                    >
            ...
            <section className="bg-forest-900 border-y border-white/5">
                <Wrapper className="py-0!">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4">
                        {trustItems.map((item) => (
                            ...
                            >
                                <span className="h-2 w-2 rounded-full bg-forest-light shrink-0" />

                                <span className="text-white/70 text-xs uppercase tracking-wider font-semibold text-center">
                                    {item}
                                </span>
                            </div>
                        ))}
            ...
            >
                <Wrapper>
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-forest-800">
                                Who Is This For
                            </span>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-8">
                                {industries.map((item) => {
                                    ...
                                    return (
                                        <div
                                            key={item.title}
                                            className="flex items-center gap-3 rounded-2xl bg-white border border-border-soft p-4 hover:border-forest-700 hover:bg-forest-100 transition-all"
                                        >
                                            <Icon className="w-5 h-5 text-forest-800 shrink-0" />
                            ...
                            return (
                                ...
                                >
                                    {index !== steps.length - 1 && (
                                        <div className="hidden xl:flex absolute -right-4 top-10 z-10 h-8 w-8 rounded-full bg-forest-800 items-center justify-center text-white">
                                            <ArrowRight className="w-4 h-4" />
                                        </div>
                                    )}

                                    <span className="text-xs font-bold tracking-widest uppercase text-forest-800">
                                        Step {item.step}
                                    </span>

                                    <Icon className="w-10 h-10 text-forest-800 mt-5" />
                            ...
                            <div className="mt-10 space-y-4">
                                {benefits.map((item) => {
                                    ...
                                    return (
                                        <div
                                            key={item.title}
                                            className="flex gap-4 bg-white border-l-4 border-forest-800 rounded-2xl p-5 shadow-sm"
                                        >
                                            <Icon className="w-6 h-6 text-forest-700 shrink-0 mt-1" />
                ...
                <Wrapper>
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-px overflow-hidden rounded-3xl bg-white/10 border border-white/10 mt-10">
                                {stats.map((item) => (
                                    <div
                                        key={item.label}
                                        className="bg-white/5 p-8 text-center"
                                    >
                                        <p className="text-4xl font-bold text-forest-light">
                                            {item.value}
                                        </p>
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <blockquote className="text-center text-white/50 italic leading-relaxed max-w-lg">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6 mt-14">
                        ...
                        >
                            <div className="w-14 h-14 rounded-2xl bg-forest-100 flex items-center justify-center">
                                <Mail className="w-6 h-6 text-forest-800" />
                            </div>
                            ...
                            <Link
                                ...
                                className="block mt-2 font-semibold text-content hover:text-forest-800"
                            >
                        ...
                        >
                            <div className="w-14 h-14 rounded-2xl bg-forest-100 flex items-center justify-center">
                                <Phone className="w-6 h-6 text-forest-800" />
                            </div>
                        ...
                        >
                            <div className="w-14 h-14 rounded-2xl bg-forest-100 flex items-center justify-center">
                                <MapPin className="w-6 h-6 text-forest-800" />
                            </div>
